...
function getSidebarContent(activeSection: string, spaces: any[], role: string, pathname: string): SidebarContent {
...
function DetailSidebar({ activeSection, spaces, role, user, org }: { activeSection: string; spaces: any[]; role: string; user: any; org: any }) {
...
export function TwoLevelSidebar() {
  ...
  const { user, org, role, spaces, isLoading, fetchUserData } = useUserStore();
