    ...
    <header className={`fixed top-6 left-1/2 transform -translate-x-1/2 z-20
      ...
      <div className="flex items-center justify-between w-full gap-x-20">
        ...
        <div className="hidden sm:flex items-center gap-3">
          ...
          <Link href="/register" className="px-4 py-2 text-xs font-bold text-black bg-white rounded-full hover:bg-gray-200 transition-colors">
            Empezar gratis
          </Link>
        </div>
          ...
          >
            <nav className="flex flex-col items-center space-y-4 pt-6 pb-4 w-full">
              ...
              <div className="flex flex-col gap-3 w-full pt-4">
                ...
                <Link href="/register" className="px-4 py-2 text-center text-sm font-bold text-black bg-white rounded-full">
                  Empezar gratis
                </Link>
              </div>
            </nav>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="space-y-4">
                    <button className="w-full flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 text-white border border-white/10 rounded-full py-4 transition-all">
                    ...
                    <form onSubmit={handleEmailSubmit} className="relative group">
                      <input
                        ...
                        className="w-full bg-white/5 text-white border border-white/10 rounded-full py-4 px-6 focus:outline-none focus:border-white/30 text-center transition-all"
                        required
                        disabled={isLoading}
                      />
                      <button
                        ...
                        disabled={isLoading}
                        className={cn(
                          "absolute right-2 top-2 text-black w-10 h-10 flex items-center justify-center rounded-full bg-white hover:bg-gray-200 transition-colors",
                  ...
                  <div className="flex items-center justify-center gap-2">
                    {code.map((digit, i) => (
                      <input
                        ...
                        className={cn(
                          "w-12 h-14 text-center text-2xl font-bold bg-white/5 text-white border border-white/10 rounded-2xl focus:outline-none focus:border-white/40 transition-all",
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        disabled={isLoading}
                        className="flex-1 rounded-full bg-white/5 text-white border border-white/10 py-3 hover:bg-white/10 transition-all disabled:opacity-50"
                      >
                        Atrás
                      </button>
                      <button
